...
class Config:
    ...
    EXCHANGE_NAME_TRANSER_TO_DOCUMENT = os.getenv('EXCHANGE_NAME_TRANSER_TO_DOCUMENT')
    ...
    EXCHANGE_NAME_CITIZEN_TO_CONFIRM = os.getenv('EXCHANGE_NAME_CITIZEN_TO_CONFIRM')
